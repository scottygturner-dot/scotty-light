...
export default function CoastalAirbnbRetreat() {
  return (
    <Layout>
      <Head>
        <title>Coastal Airbnb Retreat — Coming Soon | Scotty Light</title>
      ...
      <section className={styles.wrap}>
        <div className={styles.inner}>
          ...
          <h1 className={`display-sm ${styles.title}`}>Coastal Airbnb Retreat</h1>
