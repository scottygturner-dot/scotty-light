...
export default function ModernOutdoorEntry() {
  return (
    <Layout>
      <Head>
        <title>Modern Outdoor Entry — Coming Soon | Scotty Light</title>
      ...
      <section className={styles.wrap}>
        <div className={styles.inner}>
          ...
          <h1 className={`display-sm ${styles.title}`}>Modern Outdoor Entry</h1>
