...
export default function BoutiqueHotelBathroom() {
  return (
    <Layout>
      <Head>
        <title>Boutique Hotel Bathroom — Coming Soon | Scotty Light</title>
      ...
      <section className={styles.wrap}>
        <div className={styles.inner}>
          ...
          <h1 className={`display-sm ${styles.title}`}>Boutique Hotel Bathroom</h1>
