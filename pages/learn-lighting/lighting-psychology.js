...
export default function LightingPsychology() {
  return (
    <Layout>
      <Head>
        <title>Lighting Psychology: How Light Affects Mood and Behaviour — Coming Soon | Scotty Light</title>
        <meta name="description" content="This Learn Lighting article is coming soon. Check back for the full guide." />
      </Head>
      <section className={styles.wrap}>
        <div className={styles.inner}>
          <span className={styles.badge}>Coming Soon</span>
          <h1 className={`display-sm ${styles.title}`}>Lighting Psychology: How Light Affects Mood and Behaviour</h1>
