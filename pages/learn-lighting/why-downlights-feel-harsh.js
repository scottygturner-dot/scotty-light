...
export default function WhyDownlightsFeelHarsh() {
  return (
    <Layout>
      <Head>
        <title>Why Downlights Feel Harsh (And What To Do About It) — Coming Soon | Scotty Light</title>
        <meta name="description" content="This Learn Lighting article is coming soon. Check back for the full guide." />
      </Head>
      <section className={styles.wrap}>
        <div className={styles.inner}>
          <span className={styles.badge}>Coming Soon</span>
          <h1 className={`display-sm ${styles.title}`}>Why Downlights Feel Harsh (And What To Do About It)</h1>
