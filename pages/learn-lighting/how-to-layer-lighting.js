...
export default function HowToLayerLighting() {
  return (
    <Layout>
      <Head>
        <title>How To Layer Lighting Like an Interior Designer — Coming Soon | Scotty Light</title>
        <meta name="description" content="This Learn Lighting article is coming soon. Check back for the full guide." />
      </Head>
      <section className={styles.wrap}>
        <div className={styles.inner}>
          <span className={styles.badge}>Coming Soon</span>
          <h1 className={`display-sm ${styles.title}`}>How To Layer Lighting Like an Interior Designer</h1>
